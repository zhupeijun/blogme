...
server "192.168.2.103", :web, :app, :db, primary: true

# Set application settings
set :application, "blogme"
set :user, "server" # As defined on your server
set :password, "force1024"
set :port, 22
...
set :scm, "git"
set :repository, "https://github.com/zhupeijun/#{application}.git"
set :branch, "master"
